            ...
            <ul class="nav navbar-nav flex-row">
                ...
                <li class="nav-item mr-auto">
                    <a class="navbar-brand" href="#">
                        {{ Html::image('admins/app-assets/images/m/logo.png', 'logo', ['class' => 'brand-logo', 'width' => 140]) }}
                    </a>
            ...
            <div class="collapse navbar-collapse" id="navbar-mobile">
                <ul class="nav navbar-nav mr-auto float-left">
                    ...
                    <ul class="mega-dropdown-menu dropdown-menu row">
                        <li class="col-md-2">
                            <h6 class="dropdown-menu-header text-uppercase mb-1"><i class="la la-newspaper-o"></i> News
                            </h6>
                            <div id="mega-menu-carousel-example">
                                <div>
                                    <img class="rounded img-fluid mb-1" src="{{ asset('') }}admins/app-assets/images/slider/slider-2.png"
                            ...
                            <div id="accordionWrap" role="tablist" aria-multiselectable="true">
                                <div class="card border-0 box-shadow-0 collapse-icon accordion-icon-rotate">
                                    ...
                                    <div class="card-collapse collapse" id="accordionThree" role="tabpanel"
                                        ...
                                        <div class="card-content">
                                            <p class="accordion-text">Candy cupcake sugar plum oat cake wafer marzipan
                                                jujubes
                    ...
                    <li class="dropdown dropdown-user nav-item">
                        <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown"
                           aria-expanded="false">
                            <span class="mr-1">Hello,
                                <span
                                        class="user-name text-bold-700">Laravel</span>
                                </span>

                            </span>
                            <span class="avatar avatar-online">
                                    <img src="{{ asset('') }}admins/app-assets/images/portrait/small/avatar-s-19.png"
                                         alt="avatar"><i></i></span>
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <a class="dropdown-item"
                               href="#"><i class="ft-power"></i> Logout</a>
                        </div>
                    </li>
...
{{--                        <a class="open_notification nav-link nav-link-label" href="#" data-toggle="dropdown"><i--}}
{{--                                    class="ficon ft-bell"></i>--}}
{{--                            <span--}}
{{--                                    class="badge badge-pill badge-default badge-danger badge-default badge-up badge-glow numbers">{{$increment3}}</span>--}}
{{--                        </a>--}}
...
{{--                                </h6>--}}
{{--                                <span class="notification-tag badge badge-default badge-danger float-right m-0"><span class="numbers">{{$increment3}}</span>--}}
{{--                                        New</span>--}}
{{--                            </li>--}}
{{--                            <li class="content_pusher scrollable-container media-list w-100">--}}
{{--                                @if(count($products) > 0)--}}
{{--                                <a class="products_click" href="{{route('administration.all.notifications')}}">--}}
{{--                                    <div class="media"  style="background-color: #8282972e">--}}
{{--                                        <div class="media-left align-self-center"><i--}}
{{--                                                    class="ft-plus-square icon-bg-circle bg-cyan"></i></div>--}}
{{--                                        <div class="media-body">--}}
{{--                                            <h6 class="media-heading">You have <span class="numbers_products">{{count($products)}}</span> new Products </h6>--}}
{{--                                            <small>--}}
{{--                                                <time class="media-meta text-muted"--}}
{{--                                                      datetime="2015-06-11T18:29:20+08:00">{{(optional($last_product_date)->created_at != null) ? $last_product_date->created_at->diffForHumans() : null}}--}}
{{--                                                </time>--}}
{{--                                            </small>--}}
{{--                                        </div>--}}
{{--                                    </div>--}}
...
{{--                                @if(count($brands) > 0)--}}
{{--                                <a class="brands_click" href="{{route('administration.all.notifications' ,  ['type' => 'brands'])}}">--}}
{{--                                    <div class="media"  style="background-color: #8282972e">--}}
{{--                                        <div class="media-left align-self-center"><i--}}
{{--                                                    class="ft-plus-square icon-bg-circle bg-cyan"></i></div>--}}
{{--                                        <div class="media-body">--}}
{{--                                            <h6 class="media-heading">You have <span class="numbers_brands">{{count($brands)}}</span> new Brands </h6>--}}
{{--                                            <small>--}}
{{--                                                <time class="media-meta text-muted"--}}
{{--                                                      datetime="2015-06-11T18:29:20+08:00">{{($last_brand_date->created_at != null) ? $last_brand_date->created_at->diffForHumans() : null}}--}}
{{--                                                </time>--}}
{{--                                            </small>--}}
{{--                                        </div>--}}
{{--                                    </div>--}}
...
{{--                                @if(count($tags) > 0)--}}
{{--                                <a class="tags_click" href="{{route('administration.all.notifications' , ['type' => 'tags'])}}">--}}
{{--                                    <div class="media"  style="background-color: #8282972e">--}}
{{--                                        <div class="media-left align-self-center"><i--}}
{{--                                                    class="ft-plus-square icon-bg-circle bg-cyan"></i></div>--}}
{{--                                        <div class="media-body">--}}
{{--                                            <h6 class="media-heading">You have <span class="numbers_tags">{{count($tags)}}</span> new Tags </h6>--}}
{{--                                            <small>--}}
{{--                                                <time class="media-meta text-muted"--}}
{{--                                                      datetime="2015-06-11T18:29:20+08:00">{{($last_tag_date->created_at != null) ? $last_tag_date->created_at->diffForHumans() : null}}--}}
{{--                                                </time>--}}
{{--                                            </small>--}}
{{--                                        </div>--}}
{{--                                    </div>--}}
...
{{--                                                                href="{{route('administration.all.notifications')}}">Read all notifications</a>--}}
{{--                            </li>--}}
{{--                        </ul>--}}
{{--                    </li>--}}
                    <li class="dropdown dropdown-notification nav-item">
                            ...
                            <li class="scrollable-container media-list w-100">
                                    ...
                                    <div class="media">
                                        <div class="media-left">
                                                <span class="avatar avatar-sm avatar-busy rounded-circle">
                                                    <img src="{{ asset('') }}admins/app-assets/images/portrait/small/avatar-s-2.png"
                                                         alt="avatar"><i></i></span>
                                        </div>
                                        <div class="media-body">
                                ...
                                <a href="javascript:void(0)">
                                    <div class="media">
                                        <div class="media-left">
                                                <span class="avatar avatar-sm avatar-online rounded-circle">
                                                    <img src="{{ asset('') }}admins/app-assets/images/portrait/small/avatar-s-3.png"
                                                         alt="avatar"><i></i></span>
                                        </div>
                                        <div class="media-body">
                                    ...
                                    <div class="media">
                                        <div class="media-left">
                                                <span class="avatar avatar-sm avatar-away rounded-circle">
                                                    <img src="{{ asset('') }}admins/app-assets/images/portrait/small/avatar-s-6.png"
                                                         alt="avatar"><i></i></span>
                                        </div>
                                        <div class="media-body">
