             ...
             <div class="row">
                <div class="col-md-6">
                    <div class="form-group row mx-1">
                        ...
                        class="form-control" placeholder="{{ trans('interface.countryCode') }}" name="code" type="text" id="code">
                            @error('code')
                ...
                <div class="col-md-6">
                    <div class="form-group row mx-1">
                        <label for="phone_length" class="label-control">{{ trans('interface.countryNumberLength') }}</label>
                        <input wire:model.lazy="phone_length"
                        class="form-control" placeholder="{{ trans('interface.countryPhonrNumberPlaceHolder') }}" name="phone_length" type="text" id="phone_length">
                            @error('phone_length')
                 ...
                 <div class="col-md-6">
                     <div class="form-group row mx-1">
                         ...
                         class="form-control" placeholder="{{ trans('interface.nameArabic') }}" name="name_ar" type="text" id="NameArabic">
                             @error('name_ar')
                             <p class="errorCountry text-center text-danger ">{{ $message }}</p>
                             @enderror
                     </div>
                 ...
                 <div class="col-md-6">
                     <div class="form-group row mx-1">
                         ...
                         class="form-control" placeholder="{{ trans('interface.nameEnglish') }}" name="name_en" type="text" id="NameEnglish">
                             @error('name_en')
                             <p class="errorCountry text-center text-danger ">{{ $message }}</p>
                             @enderror
                     </div>
